...
/** Armazena a autorização local usando uma chave não exportável do Android Keystore. */
public final class SecureStore {
    private SecureStore() {}

    private static final String PREFS = "replayx_receiver_secure_license";
    private static final String ALIAS = "ReplayXReceiverLicenseKey";
