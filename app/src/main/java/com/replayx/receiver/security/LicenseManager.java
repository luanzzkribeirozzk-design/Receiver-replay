    ...
    public static Result validate(Context ctx, String rawKey) {
        ...
        try {
            ...
            if (slot1.isEmpty() && !legacyDevice.isEmpty()) {
                ...
                if (!com.replayx.receiver.util.Fs.patchDoc("keys/" + docId, migration, migrationMask.toString(), "")) {
                    out.message = com.replayx.receiver.util.Fs.lastPatchDiagnostic("migração");
                    return out;
                }
                count = 1;
            }
            ...
            if (!slot1.isEmpty() && slot1.equals(myDevice) || !slot2.isEmpty() && slot2.equals(myDevice)) {
                ...
                if (!com.replayx.receiver.util.Fs.patchDoc("keys/" + docId, patch, mask.toString(), "")) {
